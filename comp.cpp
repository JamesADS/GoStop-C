...
Assistance Received:
********************************************************************* */
std::vector<std::vector<card>>&comp::getCapPile()
{
	return capPile;
}
...
Purpose: determines if the computer player can complete an existing capture pile pair based on their hand and the layout. (for use in the firstMove function for computers)
...
Assistance Received:
********************************************************************* */
int comp::canMakeQuartet(std::vector<std::vector<card>>& LAY, gameboard& GB)
{
	GB.reduc(capPile);
...
Assistance Received:
********************************************************************* */
int comp::mostMatches(std::vector<std::vector<card>> &LAY, gameboard &GB) 
{
	int mostMatchingIndex = 0;
	int matches = 0;
	//for every card in the computer hand
	for (int i = 0; i < hand.size(); i++)
	{
...
Purpose: sets the computer hand to a supplied vector of cards.
...
Assistance Received:
********************************************************************* */
void comp::setHand(std::vector<card>& setTo)
{
	hand = setTo;
}
...
Purpose: sets the computer Capture Pile to a supplied vector of vector of cards.
...
Assistance Received:
********************************************************************* */
void comp::setCapPile(std::vector<std::vector<card>>& setTo) 
{
	capPile = setTo;
}
...
Assistance Received:
********************************************************************* */
void comp::matchesCapPilePair(std::vector<card>& newPile, std::vector<std::vector<card>>& CP) {
...
Assistance Received:
********************************************************************* */
void comp::setScoreAdd(int setTo) 
{
	score += setTo;
}
